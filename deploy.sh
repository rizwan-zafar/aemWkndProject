...
# #all
# curl -u $USER_NAME:$PASSWORD -F cmd=upload -F force=true -F package=@all/target/cxp-wp.all-1.0.zip http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json
# curl -u $USER_NAME:$PASSWORD -F cmd=install http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json/etc/packages/sa.com.stc/cxp-wp.all-1.0.zip


# #apps
# curl -u $USER_NAME:$PASSWORD -F cmd=upload -F force=true -F package=@ui.apps/target/cxp-wp.ui.apps-1.0.zip http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json
# curl -u $USER_NAME:$PASSWORD -F cmd=install http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json/etc/packages/sa.com.stc/cxp-wp.ui.apps-1.0.zip



# #bundle
# curl -u $USER_NAME:$PASSWORD -F action=install -F bundlestartlevel=20 -F bundlefile=@"core/target/cxp-wp.core-1.0.jar" http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/system/console/bundles 




# #config
# curl -u $USER_NAME:$PASSWORD -F cmd=upload -F force=true -F package=@ui.config/target/cxp-wp.ui.config-1.0.zip http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json
# curl -u $USER_NAME:$PASSWORD -F cmd=install http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json/etc/packages/sa.com.stc/cxp-wp.ui.config-1.0.zip


# #content
# curl -u $USER_NAME:$PASSWORD -F cmd=upload -F force=true -F package=@ui.content/target/cxp-wp.ui.content-1.0.zip http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json
# curl -u $USER_NAME:$PASSWORD -F cmd=install http://$AEM_PUBLISH_HOST:$AEM_PUBLISH_PORT/crx/packmgr/service/.json/etc/packages/sa.com.stc/cxp-wp.ui.content-1.0.zip
