...
# curl -u $USER_NAME:$PASSWORD -F cmd=install http://$AEM_AUTHOR_HOST:$AEM_AUTHOR_PORT/crx/packmgr/service/.json/etc/packages/com.adobe.aem.guides/cxp-wp.ui.config-1.0.zip
