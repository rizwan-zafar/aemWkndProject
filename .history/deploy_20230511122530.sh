...
curl -u $USER_NAME:$PASSWORD -F cmd=install http://$AEM_AUTHOR_HOST:$AEM_AUTHOR_PORT/crx/packmgr/setc/packages/com.adobe.aem.guides//etc/packages/com.adobe.aem.guides/aem-guides-wknd.all-0.0.1-SNAPSHOT.zip
...
curl -u $USER_NAME:$PASSWORD -F cmd=install http://$AEM_AUTHOR_HOST:$AEM_AUTHOR_PORT/crx/packmgr/service/.json/etc/packages/sa.com.stc/aem-guides-wknd.ui.apps-0.0.1-SNAPSHOT.zip
